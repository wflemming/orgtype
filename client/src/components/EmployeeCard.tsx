...
export function EmployeeCard({ employee, isRevealed, onEmployeeUpdated }: Props) {
          ...
          >
            {!isEditing ? (
              <>
                ...
                <button
                  onClick={openEditor}
                  className="mt-1 px-3 py-1 text-xs bg-white/20 rounded-lg hover:bg-white/30 transition-colors"
                >
                  Edit Info
                </button>
              </>
